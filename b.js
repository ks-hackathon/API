...
const requestConfig = {
  ...
  const contractAddress = "0x4cfe0ae14471ba408611f2528dd2325e763ff0ba";
  ...
  async function sendRequest() {
    try {
        const gasLimit = ethers.parseUnits("25000000", "wei");
      const tx = await consumerContract.sendRequest(
        requestConfig.source,
        requestConfig.secretsLocation,
        "0x", // Assuming this is correct for your contract method
        requestConfig.args,
        [], // Assuming this is correct for your contract method
        1573,
        {
            gasLimit: gasLimit // Include the higher gas limit here
          } // Assuming this is correct for your contract method
        /*10000, // Assuming this is correct for your contract method
        "0x66756e2d657468657265756d2d7365706f6c69612d3100000000000000000000"*/ // Assuming this is correct for your contract method
  ...
  async function queryVariables() {
    try {
     ...
     // const s = await consumerContract.requestToSender(requestId)
